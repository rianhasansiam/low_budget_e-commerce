// Footer data for the Digicam Market website
export const footerLinksData = [
  {
    ...
    children: [
      ...
      { id: 11, label: "Features", url: "/" },
      { id: 12, label: "Works", url: "/" },
      { id: 13, label: "Career", url: "/" },
    ],
  },
  {
    id: 2,
    title: "HELP",
    children: [
      { id: 20, label: "Customer Support", url: "/contact" },
      { id: 21, label: "Delivery Details", url: "/" },
  ...
  },
  {
    ...
    title: "FAQ",
    children: [
      { id: 30, label: "Account", url: "/" },
      { id: 31, label: "Manage Deliveries", url: "/" },
      { id: 32, label: "Orders", url: "/profile" },
      { id: 33, label: "Payments", url: "/" },
    ],
  },
  {
    id: 4,
    title: "RESOURCES",
    children: [
      { id: 40, label: "Free eBooks", url: "/" },
      { id: 41, label: "Development Tutorial", url: "/" },
      { id: 42, label: "How to - Blog", url: "/" },
      { id: 43, label: "YouTube Playlist", url: "/" },
    ],
  },
];
